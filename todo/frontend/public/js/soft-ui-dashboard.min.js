    ...
    (document.querySelector(".fixed-plugin") &&
      ...
      fixedPluginButton &&
        (fixedPluginButton.onclick = function () {
          console.log("clicked");
          document.getElementById("hh").style.right='0px';
          document.getElementById("hh").style.width='35vw';
      ...
      fixedPluginCloseButton.forEach(function (e) {
        e.onclick = function () {
          ...
          document.getElementById("hh").style.removeProperty('right');
          document.getElementById("hh").style.removeProperty('width');  
          fixedPlugin.classList.contains("show")
            ? fixedPlugin.classList.remove("show")
            : fixedPlugin.classList.add("show");
        };
